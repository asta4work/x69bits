...
export const translations: Record<Language, Translation> = {
  ...
  ar: {
    ...
    hero: {
      badge: "بنية تحتية للمؤسسات",
      title1: "استضافة الأعمال",
      title2: "مصممة للتوسع",
      subtitle: "انشر خوادم VPS والخوادم المخصصة والبنية السحابية في ثوانٍ. أداء مؤسسي مع ضمان وقت تشغيل 99.9%، حماية DDoS، ودعم فني على مدار الساعة.",
      viewPlans: "عرض الخطط",
      whyUs: "لماذا x69bits",
    ...
    features: {
      title1: "لماذا تختار",
      title2: "x69bits",
      subtitle: "بنية تحتية مؤسسية مصممة للشركات التي تتطلب الموثوقية والأداء وقابلية التوسع بدون أسعار المؤسسات.",
      items: [
    ...
    seo: {
      homeTitle: "x69bits - استضافة VPS وسحابية للمؤسسات | لوحة Pterodactyl",
      homeDescription: "انشر خوادم VPS والسحابة في ثوانٍ مع x69bits. أداء على مستوى المؤسسات، حماية DDoS، ودعم على مدار الساعة.",
      termsTitle: "شروط الخدمة | x69bits",
      termsDescription: "اقرأ شروط الخدمة لاستضافة VPS والسحابة في x69bits.",
      privacyTitle: "سياسة الخصوصية | x69bits",
      privacyDescription: "تعرف على كيفية حماية x69bits لخصوصيتك والتعامل مع بياناتك.",
    },
  },
