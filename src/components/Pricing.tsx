  ...
  return (
    <section id="pricing" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            return (
              <div
                ...
                className={`relative p-8 rounded-2xl transition-all duration-500 hover:-translate-y-2 animate-slide-up opacity-0 ${
                  config.popular
                    ? "glass border-primary/50 animate-pulse-glow"
              ...
              >
                ...
                >
                  <svg className={`w-5 h-5 ${dir === "rtl" ? "ml-2" : "mr-2"} group-hover:scale-110 transition-transform`} viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-center text-sm text-muted-foreground mt-8 animate-fade-in opacity-0" style={{ animationDelay: "0.8s" }}>
