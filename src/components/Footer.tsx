      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-8 ${dir === "rtl" ? "text-right" : ""}`}>
          ...
          <div className="md:col-span-2">
            <Link
              to="/"
              className={`flex items-center gap-2 mb-4 group ${dir === "rtl" ? "flex-row-reverse justify-end" : ""}`}
            >
            ...
            <p className="text-sm text-muted-foreground max-w-sm mb-4">{t.footer.description}</p>
